...
public class questions extends javax.swing.JFrame {
    ...
    private void tampilData(){
        try{
            Object[] judul_kolom = {"Question", "Answer"};
   ...
   void tblKeForm(){
        jTextQuestion.setText(tabModel.getValueAt(TabelProduk.getSelectedRow(),0)+"");
        jTextAnswer.setText(tabModel.getValueAt(TabelProduk.getSelectedRow(),1)+"");
   ...
   private void seteditOn(){
    ...
    private void initComponents() {
        ...
        jLabelQuestion.setText("Quesntion");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(jTextAnswer, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 257, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jTextQuestion, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 258, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(6, 6, 6)
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        ...
        if (Question.isEmpty() ) {
            JOptionPane.showMessageDialog(null,"Pertanyaan tidak boleh kosong!");
            jTextQuestion.requestFocus();
        }else if(JOptionPane.showConfirmDialog(null,"Apakah anda yakin ingin menghapus data ini?",
            "Informasi",JOptionPane.OK_CANCEL_OPTION,JOptionPane.INFORMATION_MESSAGE)==JOptionPane.OK_OPTION){
        try{
            Connection conn=(Connection)koneksi.koneksiDB();
            Statement stt=conn.createStatement();
            stt.executeUpdate("DELETE FROM messages WHERE question='"+Question+"'");
            BersihData();
            tampilData();
            SetEditOff();
